...
## Tecnologías y lenguajes\r
\r
Ahora que tienes este panorama, procedamos a organizar lo que necesitas aprender. La información detallada sobre cada elemento estará disponible en este sitio web, y las alternativas serán mencionadas en sus respectivas secciones. Aunque no todas son obligatorias, se recomiendan para optimizar el desarrollo, ampliar tu conocimiento y aumentar tus oportunidades laborales. A continuación, te presentamos una lista completa de los temas que abordaremos en este lugar:\r
\r
### Front-end\r
\r
-   Introducción\r
-   Configuración Inicial\r
-   Organización y Recopilación de Contenido\r
-   Internet\r
-   HTML\r
-   CSS\r
-   JavaScript\r
-   Git\r
-   Compilación de JavaScript\r
-   Frameworks de JavaScript\r
-   Frameworks de CSS\r
-   Procesamiento de CSS\r
\r
### Contenido Adicional\r
\r
-   Figma\r
-   SEO\r
-   Procedimiento Web\r
-   CV\r
-   Preparación para Entrevistas\r
-   Recursos\r
\r
## Aspectos adicionales\r
\r
A continuación, te presentaré contenido adicional que agilizará y enriquecerá tu proceso de aprendizaje. Quiero reiterarte que esta página no busca ser un curso completo, sino más bien una recopilación y organización de cursos. Su propósito es proporcionarte una experiencia de aprendizaje fluida y sin complicaciones. Aquí encontrarás algunos recursos valiosos:\r
\r
-   **[RoadMap](https://roadmap.sh/frontend)**: Aquí encontrarás una visión completa de todas las opciones y detalles sobre cada ruta de aprendizaje.\r
\r
-   **[FreeCodeCamp](https://www.freecodecamp.org/learn)**: Este equipo ofrece cursos gratuitos y certificaciones reconocidas en el mundo de la programación.\r
\r
-   **[Lighthouse de Google](https://developer.chrome.com/docs/lighthouse/)**: Una sección orientada a los desarrolladores por Chrome que brinda asistencia al publicar una página. Ofrece insights sobre rendimiento, SEO, accesibilidad y más.\r
\r
-   **[DevDocs](https://devdocs.io)**: Una documentación completa dedicada a cada framework, librería, herramienta o lenguaje en el mundo de la programación.\r
\r
-   **[WebDev](https://web.dev/learn/)**: Esta página es ideal para aprender conceptos básicos y contenidos más avanzados sobre desarrollo web.\r
\r
-   **[Página web de JonMircha](https://jonmircha.com/cursos)**: Este es el sitio de un respetado desarrollador web y educador en la comunidad hispana. JonMircha proporciona cursos gratuitos de desarrollo web en YouTube y los organiza en su plataforma web.\r
\r
-   Esta es la guía oficial de Google sobre las herramientas para desarrolladores de Chrome: **[Chrome DevTools](https://developer.chrome.com/docs/devtools/)**.\r
\r
-   **[Full Stack Open](https://fullstackopen.com/en/)** está dedicado a que puedas aprender desarrollo web completo. Es similar a este, pero tiene sus desventajas, como que no todo está traducido al español y no hay ningún recurso visual, es enteramente textual.\r
\r
-   Aquí te dejo un par de canales de YouTube centrados en programación:\r
    -   **[midudev](https://www.youtube.com/@midudev)**\r
    -   **[midulive](https://www.youtube.com/@midulive)**\r
    -   **[Programador X](https://www.youtube.com/@ProgramadorX)**\r
    -   **[HolaMundo](https://www.youtube.com/@HolaMundoDev)**\r
    -   **[otro más de sistemas](https://www.youtube.com/@otromasdesistemas)**\r
    -   **[Victor Robles WEB](https://www.youtube.com/@VictorRoblesWEB)**\r
    -   **[jonmircha](https://www.youtube.com/@jonmircha)**\r
    -   **[MoureDev by Brais Moure](https://www.youtube.com/@mouredev/videos)**.\r
\r
## Conclusión\r
\r
Después de esta introducción, espero que te sientas preparado para comenzar tu viaje de aprendizaje. Es importante destacar que todos los recursos y las personas mencionadas en esta página están detallados en la sección de Recursos. Sin más demora, ¡te deseo mucho éxito en tu travesía!\r
`;export{e as default};
